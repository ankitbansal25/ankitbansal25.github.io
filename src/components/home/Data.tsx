...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title">Ankit Bansal
            <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
            ...
            <p className="home__description">Hello, I am Ankit, from Bangalore, India. I have total 8+ years of experience in web and mobile development. I'm very passionate and dedicated to my work.</p>
